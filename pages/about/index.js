  ...
  return (
    <>
            ...
            <div className="col-lg-6">
              <div className="single-about-image">
                ...
                <div className="about-shape-1">
                  <img
                    src="./assets/images/about/about-shape-2.svg"
                    alt="about-shape"
                  />
                </div>
              </div>
            ...
            <div className="col-lg-6">
              <div className="single-free-quote-form">
                ...
                <form>
                  ...
                  <button
                    type="submit"
                    className="default-btn btn-padding bg-primary-light"
                  >
                    Get A Quote Now
                  </button>
                </form>
            ...
            <div className="col-lg-6">
              <div className="free-quote-image">
                <div className="free-quote-main">
                  <img
                    src="./assets/images/free-quote-1.png"
                    alt="free-quote"
                  />
                </div>
            ...
            <div className="col-lg-6">
              <div className="recruitment-img">
                ...
                <div className="recruitment-main1">
                  <img
                    src="./assets/images/recruitment-1-1.webp"
                    alt="recruitment1"
                  />
                </div>
              </div>
      ...
      <div className="testimonials-area testimonials-two-area pt-100 pb-70">
              ...
              <div className="testimonials-item">
                ...
                <div className="testimonials-card testimonials-card-three">
                  ...
                  <p>
                    ...
                    pain is cases are perfectly simple and easy to distinguish
                    in a free hour whenour power of choice is untrammelled and
                    when nothing.
                  </p>
                </div>
              </div>
        ...
        <div
          className="testimonials-3-shape"
          data-cue="zoomIn"
          data-duration="2000"
        >
          <img
            src="./assets/images/testimonials/testimonials-3-shape.webp"
            alt="testimonials"
          />
        </div>
      </div>
