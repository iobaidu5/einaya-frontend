              ...
              sx={{
                border:
                  value === "pending"
                    ? `1px solid #f8ed62`
                    : "1px solid #00A300",
                color: value === "pending" ? `#f8ed62` : "#00A300",
                borderRadius: "10px",
                fontSize: "15px",
                fontWeight: 500,
                height: "30px",
  ...
  const getAllDoctors = async () => {
    try {
      ...
      const res = await axios.get(
        `${process.env.NEXT_PUBLIC_API_URL}/api/v1/admin/get-all-insurances`,
        {
          headers: {
      ...
      <Grid container justifyContent="center" style={{ marginBottom: "20px" }}>
        ...
        >
          ...
          >
            ...
            <Typography sx={styles.text}>Total Insurances</Typography>
          </Box>
        </Grid>
      </Grid>
...
//export default ShowAllInsurances;

export default withAuth(ShowAllInsurances, ['admin']);