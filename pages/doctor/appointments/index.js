  ...
  const getAllUsers = async () => {
    try {
      ...
      if (res.data.success) {
        ...
        const approvedAppointments = dataInArray.filter(
            (app) => app.status === "approved"
          );
        setData(approvedAppointments);
      } else {
        dispatch(hideLoading());
      ...
      <Grid container justifyContent="center" style={{marginBottom: "20px"}}>
        ...
        >
          ...
          >
            ...
            <Typography sx={styles.text}>All Approved Appointments</Typography>
          </Box>
        </Grid>
      </Grid>
...
export default withAuth(UsersAppointments, ['doctor']);
